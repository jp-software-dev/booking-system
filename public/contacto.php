 ...
 * VISTA DE CONTACTO
 *
 * Interfaz dedicada a mostrar la información de ubicación, medios de comunicación
 * y horarios de operación de la clínica.
 *
        ...
        <div class="col-lg-5 col-md-6">
            <div class="card border-0 shadow-sm h-100 rounded-4 bg-primary text-white p-4 position-relative overflow-hidden">
                ...
                <div class="mt-auto pt-4">
                    <a href="<?php echo $ruta_agendar; ?>" class="btn btn-light w-100 fw-bold py-3 fs-6 rounded-pill text-primary shadow-sm">
                        Agendar Cita Ahora
                    </a>
                </div>
            </div>
